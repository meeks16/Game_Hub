...
<head>
	...
	<link rel="stylesheet" href="http://fonts.googleapis.com/css?family=Open+Sans:300,400,700"> 	<link rel="stylesheet" href="css/otherstyle.css"> -->
      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
			...
			{	
				echo '<li><a href="game_catalog.php">Game Catalog</a></li>';
				...
				if ($is_admin) {
					...
					echo '<li><a href="add_review.php">Reviews</a></li>';
				}
